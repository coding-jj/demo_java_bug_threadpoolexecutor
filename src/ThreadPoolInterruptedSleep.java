...
public final class ThreadPoolInterruptedSleep implements Runnable {
    ...
    public static void main(final String[] args) {
        new Thread(new ThreadPoolInterruptedSleep()).start();
    }
    ...
    public void run() {
        ...
        // Executor
        final ExecutorService ex = new ThreadPoolExecutor(2,
